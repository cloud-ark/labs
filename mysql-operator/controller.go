...
import (
	...
	clientset "github.com/cloud-ark/moodle-operator/pkg/client/clientset/versioned"
	operatorscheme "github.com/cloud-ark/moodle-operator/pkg/client/clientset/versioned/scheme"
	informers "github.com/cloud-ark/moodle-operator/pkg/client/informers/externalversions"
	listers "github.com/cloud-ark/moodle-operator/pkg/client/listers/moodlecontroller/v1"
...
func (c *Controller) syncHandler(key string) error {
    ...
    c.updateMoodleStatus(foo, status)
...
func (c *Controller) updateMoodleStatus(foo *operatorv1.Moodle, status string) error {
